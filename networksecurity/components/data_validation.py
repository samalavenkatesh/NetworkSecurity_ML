...
class DataValidation:
    ...
    '''
    This method used to detect the data drift i.e distribution of data it checks wether it is changing or not.
    '''
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            if not status:
                error_message = "Train dataframe does not have all required numerical columns.\n"

            status = self.is_numerical_columns_exist(dataframe=test_dataframe)
            if not status:
                error_message = "Test dataframe does not have all required numerical columns.\n"
